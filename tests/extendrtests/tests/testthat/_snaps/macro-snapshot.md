# Macro expansion of lib.rs
    ...
    Output
      ...
      fn check_default_deprecated(x: Robj) -> bool {
          x.is_null()
      }
      #[no_mangle]
      #[allow(non_snake_case, clippy::not_unsafe_ptr_arg_deref)]
      pub extern "C" fn wrap__check_default_deprecated(
          x: extendr_api::SEXP,
      ) -> extendr_api::SEXP {
          use extendr_api::robj::*;
          let wrap_result_state: std::result::Result<
          ...
          > = unsafe {
              std::panic::catch_unwind(
                  ...
                  > {
                      ...
                      Ok(
                          extendr_api::Robj::from(
                              check_default_deprecated(_x_robj.try_into()?),
                          ),
                      )
                  }),
              )
      ...
      #[allow(non_snake_case)]
      fn meta__check_default_deprecated(metadata: &mut Vec<extendr_api::metadata::Func>) {
          let mut args = Vec::with_capacity(1usize);
          args.push(extendr_api::metadata::Arg {
              name: "x",
              arg_type: "Robj",
          ...
          metadata
              .push(extendr_api::metadata::Func {
                  doc: "",
                  rust_name: "check_default_deprecated",
                  r_name: "check_default_deprecated",
                  mod_name: "check_default_deprecated",
                  args: args,
                  return_type: "bool",
                  func_ptr: wrap__check_default_deprecated as *const u8,
                  hidden: false,
                  invisible: None,
              })
      }
