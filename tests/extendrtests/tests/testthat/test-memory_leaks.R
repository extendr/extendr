...
e_pkg = environment(extendrtests:::leak_implicit_doubles)
fnames = c(
...
value_f_list = list(
  #big_string = \() paste(sample(letters,1E2, replace = TRUE),collapse = ""),
...
test_that("score_leak test function does detect a leak", {
