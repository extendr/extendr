...
- `extendr-api` and `extendr-engine` its dependency on `libR-sys` instead using the new `extendr-ffi` which is smaller and provided backports. [[#888]](https://github.com/extendr/extendr/pull/888)
