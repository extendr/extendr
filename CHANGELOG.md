...
- `Strings`, `Doubles`, `Integers`, `Complexes`, and `Logicals` structs now have associated method `new_na_filled()` to construct empty vectors of NA values <https://github.com/extendr/extendr/pull/871>
