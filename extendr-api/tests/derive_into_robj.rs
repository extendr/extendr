// Tests for the #[derive(IntoRobj)] macro
// Testing conversion of Rust structs to R lists with various field types
...
mod tests {
    ...
    #[test]
    fn test_into_robj_basic_types() {
        test! {
            #[derive(IntoRobj, Debug)]
            struct BasicTypes {
                a: i32,
                b: f64,
                c: bool,
    ...
    #[test]
    fn test_into_robj_vector_types() {
        test! {
            #[derive(IntoRobj, Debug)]
            struct VectorTypes {
                integers: Vec<i32>,
    ...
    #[test]
    fn test_into_robj_with_robj_types() {
        test! {
            #[derive(IntoRobj, Debug)]
    ...
    #[test]
    fn test_into_robj_with_function() {
        test! {
            #[derive(IntoRobj, Debug)]
            struct WithFunction {
                name: String,
    ...
    #[test]
    fn test_into_robj_with_pairlist() {
        test! {
            #[derive(IntoRobj, Debug)]
            struct WithPairlist {
                data: Pairlist,
    ...
    #[test]
    fn test_into_robj_with_environment() {
        test! {
            #[derive(IntoRobj, Debug)]
    ...
    #[test]
    fn test_into_robj_with_ignore_attribute() {
        test! {
            #[derive(IntoRobj, Debug)]
            struct WithIgnored {
                public_field: String,
    ...
    #[test]
    fn test_into_robj_nested_structs() {
        test! {
            #[derive(IntoRobj, Debug)]
            struct Inner {
                x: i32,
    ...
    #[test]
    fn test_into_robj_from_reference() {
        test! {
            #[derive(IntoRobj, Debug)]
            struct SimpleStruct {
                value: i32,
    ...
    #[test]
    fn test_into_robj_example_from_pr() {
        test! {
            ...
            #[derive(Debug, PartialEq, IntoRobj)]
            struct MyFunc {
                doc: &'static str,
    ...
    #[test]
    fn test_into_robj_empty_collections() {
        test! {
            #[derive(IntoRobj, Debug)]
