...
fn test_derive_list() {
    ...
    #[derive(TryFromList, IntoList, PartialEq, Debug)]
    struct Foo {
        a: u16,
        b: String,
        c: Vec<f64>,
    ...
    test! {
        ...
        let native_r: List = native_r.try_into().unwrap();
        ...
        let converted_r_borrow: List = (&native_rust).into();
        ...
        assert_eq!(&native_r, &List::from(&converted_rust_borrow));
        ...
        let converted_r_owned: List = native_rust.into();
