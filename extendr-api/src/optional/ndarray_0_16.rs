...
*/
#[doc(hidden)]
use ndarray_0_16::prelude::*;
use ndarray_0_16::{Data, ShapeBuilder};
...
mod test {
    ...
    fn test_from_robj<DataType, DimType, Error>(
        ...
        DataType: Data,
        Error: std::fmt::Debug,
        for<'a> ArrayView<'a, <DataType as ndarray_0_16::RawData>::Elem, DimType>:
            TryFrom<&'a Robj, Error = Error>,
        DimType: Dimension,
        <DataType as ndarray_0_16::RawData>::Elem: PartialEq + std::fmt::Debug,
        Error: std::fmt::Debug,
    {
